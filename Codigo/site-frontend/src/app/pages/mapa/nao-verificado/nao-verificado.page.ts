...
@Component({
  selector: 'app-nao-verificado',
  templateUrl: './nao-verificado.page.html',
  styleUrls: ['./nao-verificado.page.scss'],
})
export class NaoVerificadoPage implements OnInit, OnDestroy {
  map!: Leaflet.Map;
